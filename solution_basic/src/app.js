...
class App {
  ...
  serve() {
    return http.createServer((req, res) => {
      ...
      this.getTitlesForAddressesAndRespond(res, addresses)
    })
  }
  ...
  getTitlesForAddressesAndRespond(res, addresses) {
    ...
    addresses.forEach((address) => {
      ...
      protocol.get(address, (response) => {
        ...
        response.on('end', () => {
          ...
          if (--remaining === 0) { // first decrement the remaining count then check 
